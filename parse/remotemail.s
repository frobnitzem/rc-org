...
compile: (sender=($ 1) <nil>)
compile: (simple shift)
compile: (addr=($ 1) <nil>)
compile: (simple shift)
compile: (fd=(` (brace (simple (arglist (arglist upas/aliasmail -f) ($ sender))))) <nil>)
compile: (switch (paren (words <nil> ($ fd))) (brace (; (simple (arglist case *.*)) (; (simple (arglist case *)) (fd=YOURDOMAIN.DOM <nil>)))))
compile: (simple (arglist (arglist (arglist (arglist (arglist (arglist exec upas/smtp) -h) ($ fd)) ($ addr)) ($ sender)) ($ *)))
