...
compile: <nil>
compile: <nil>
compile: (if (paren (~ ($# PLAN9) (words <nil> 0))) (PLAN9=/usr/local/plan9port <nil>))
compile: (if (paren (! (~ ($sub path (words <nil> 1)) (words <nil> (^ ($ PLAN9) /bin))))) (path=(paren (words (words <nil> (^ ($ PLAN9) /bin)) ($ path))) <nil>))
compile: <nil>
