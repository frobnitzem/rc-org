...
compile: <nil>
compile: <nil>
compile: (simple (arglist echo '<pre>'))
compile: (simple (arglist echo (^ '<a href="/plan9port">Plan 9 from User Space</a> ' ($ 2))))
compile: (simple echo)
compile: (@ (| (brace (; (simple (arglist cd ($ 1))) (simple (arglist (arglist 9 ls) -lF)))) (simple (arglist (arglist 9 sed) (^ (^ 's!^(.-......... M 0 )[^ ]+ [^ ]+ (.*) (.*[^*])!\1 glenda sys \2 <a href=' \3) '>\3</a>!'))))
compile: (simple (arglist echo '</pre>'))
