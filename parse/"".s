...
compile: <nil>
compile: <nil>
compile: (cmd=(` (brace (| (simple (arglist quote1 ($ *))) (simple (arglist tail -1)))) <nil>)
compile: (if (paren (~ ($# cmd) (words <nil> 0))) (brace (; (>[1=2] (simple (arglist (arglist (arglist (arglist (arglist echo no) such) command) found) <nil>))) (simple (arglist exit notfound)))))
compile: <nil>
compile: (>[1=2] (simple (arglist (arglist (arglist echo '	') ($ cmd)) <nil>)))
compile: (simple (arglist (arglist rc -c) ($" cmd)))
