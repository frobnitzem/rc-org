...
%%EndFeature') <nil>) (; (simple (arglist case *)) (>[1=2] (simple (arglist (arglist (arglist (arglist (arglist (arglist echo illegal) option) (^ '''' -i)) (^ ($ i) '''')) ignored) <nil>)))))))))))))))))))
compile: <nil>
compile: <nil>
compile: <nil>
compile: <nil>
...
') <nil>)
compile: <nil>
compile: (| (brace (; (simple (arglist echo ($ PATCH))) (simple psextract))) (simple (^ ($ LPLIB) /process/hpost))
compile: <nil>
