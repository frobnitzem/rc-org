...
compile: <nil>
compile: (switch (paren (words <nil> ($# *))) (brace (; (simple (arglist case 0)) (simple (arglist exec upas/nedmail)))))
compile: <nil>
compile: (switch (paren (words <nil> ($ 1))) (brace (; (simple (arglist (arglist (arglist (arglist case -f*) -r*) -c*) -m*)) (; (simple (arglist (arglist exec upas/nedmail) ($ *))) (; (simple (arglist case *)) (simple (arglist (arglist exec upas/marshal) ($ *))))))))
