...
compile: <nil>
compile: (if (paren (~ ($ LPCLASS) (words <nil> *sendEOT*))) (SENDEOT=1 <nil>))
compile: (if not (SENDEOT=0 <nil>))
compile: <nil>
compile: (if (paren (~ ($ OUTDEV) (words <nil> -))) (OUTDEV=/dev/stdout <nil>))
compile: (if (paren (~ ($# *) (words <nil> 0))) (brace (; (if (paren (! (~ ($ DEBUG) (words <nil> '')))) (>[1=2] (simple (arglist (arglist (arglist (arglist (arglist echo input) file) is) stdin) <nil>)))) (; (>($ OUTDEV) (simple (arglist (arglist (arglist lpsub process) ($ LPPROC)) <nil>))) (if (paren (~ ($ SENDEOT) (words <nil> 1))) (>($ OUTDEV) (simple (arglist (arglist (arglist echo -n) (` (brace (simple (arglist (arglist ascii -t) 4))))) <nil>))))))))
compile: (if not (brace (; (if (paren (! (~ ($ DEBUG) (words <nil> '')))) (>[1=2] (simple (arglist (arglist (arglist (arglist echo input) files) ($ *)) <nil>)))) (for i (words <nil> ($ *)) (brace (; (if (paren (! (~ ($ DEBUG) (words <nil> '')))) (>[1=2] (simple (arglist (arglist (arglist echo processing) ($ i)) <nil>)))) (; (<($ i) (>($ OUTDEV) (simple (arglist (arglist (arglist (arglist lpsub process) ($ LPPROC)) <nil>) <nil>)))) (if (paren (~ ($ SENDEOT) (words <nil> 1))) (>($ OUTDEV) (simple (arglist (arglist (arglist echo -n) (` (brace (simple (arglist (arglist ascii -t) 4))))) <nil>)))))))))))
